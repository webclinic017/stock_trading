...
def simulation(prices, quotes, daily_data, shadow_length):
    ...
    for row in range(1, len(all_data)-1):
        ...
        if close_price > open_price and close_price == high_price and lower_wick_length * shadow_length > body_length and daily_data[day_minus_2_str]["ma"].values[0] < daily_data[day_minus_1_str]["ma"].values[0] and prev_diff < 100:
