...
def log_trades(open_trades, close_trades, symbol, diff_scaling):
    ...
    history.to_csv(str(diff_scaling) + ".csv")
...
if __name__ == "__main__":
    ...
    log_trades(open_trades, close_trades, symbol, diff_scaling)
