...
def simulation(prices, quotes, shadow_length, short_ma, long_ma):
    ...
    for row in range(len(all_data)-1):
        ...
        if close_price > open_price and close_price == high_price and lower_wick_length * shadow_length > body_length and short_ma_price > long_ma_price:
...
if __name__ == "__main__":
    ...
    open_trades, close_trades = simulation(prices, quotes, shadow_length, short_ma, long_ma)
