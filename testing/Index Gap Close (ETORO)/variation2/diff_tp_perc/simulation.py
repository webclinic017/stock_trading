...
def process_date(api, symbol, prev_date, curr_date, etoro_sl, exit_time, no_trade_min, tp_limit, tp_perc, sl_perc):
...
if __name__ == "__main__":
    ...
    for date_i in range(1, len(calendar)):
        ...
        trade_data = process_date(api, symbol, prev_date, curr_date, etoro_sl, exit_time, no_trade_min, tp_limit, tp_perc, sl_perc)
        all_trade_data.append(trade_data)
            
    all_trade_data = pd.concat(all_trade_data)
    all_trade_data.to_csv(symbol + "_" + str(exit_time) + "_" + str(no_trade_min) + "_" + str(tp_limit) + "_" + str(tp_perc) + "_" + str(sl_perc) + ".csv")
