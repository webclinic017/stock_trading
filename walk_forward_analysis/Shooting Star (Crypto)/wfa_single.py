...
if __name__ == "__main__":
    ...
    for file_i, file in enumerate(files):
        ...
        params.append(list(map(int, file.replace(".csv", "").split("_"))))
    ...
    for wfa_period in wfa_periods:
        ...
        best_csvs.to_csv("wfa_single/best_single_"+symbol+"_"+str(wfa_period)+".csv")
        wfas.to_csv("wfa_single/wfa_single_"+symbol+"_"+str(wfa_period)+".csv")
